                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Tiempo extraordinario que tiene un cliente para cancelar</label>
                                    <input type="number" step="1" class="form-control" id="tiempo">
                                </div>
        ...
        axios.post('/admin/dinero/limite/informacion',{
            ...
            .then((response) => {
                ...
                if(response.data.success == 1){
                    ...
                    $('#tiempo').val(response.data.info.tiempo);
