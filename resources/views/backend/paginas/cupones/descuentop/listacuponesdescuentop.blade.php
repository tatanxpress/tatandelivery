...
<section class="content-header">
      <div class="container-fluid">
          <div class="col-sm-12">
            <h1>Lista de cupones para Descuento Porcentaje</h1>
          </div>             
...
<!-- modal crear cupon -->
<div class="modal fade" id="modalDescuentoP">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Crear Cupón Descuento Porcentaje</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Porcentaje (No Decimal)</label>
                                    <input type="number" min="1" max="100" step="1" value="1" class="form-control" id="porcentaje-nuevo" placeholder="Descuento %">
                                </div>

                                
                                <div class="form-group">
                                    <label>Minimo para aplicar en carrito de compras</label>
                                    <input type="number" step="0.01" value="0" class="form-control" id="dinero-nuevo" placeholder="Dinero Minimo a aplicar">
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="100" step="1" value="1" class="form-control" id="porcentaje-editar" placeholder="Dinero descuento">
                                </div>

                                <div class="form-group">
                                    <label>Minimo para aplicar en carrito de compras</label>
                                    <input type="number" step="0.01" class="form-control" id="dinero-editar" placeholder="Dinero Minimo a aplicar">
                                </div>
 ...
 <!-- incluir tabla --> 
  <script type="text/javascript">	 
    $(document).ready(function(){
        var ruta = "{{ URL::to('admin/cupones/tabla/descuentop') }}";
  ...
  <script>  
    ...
    function nuevoCupon(){
        ...
        var porcentaje = document.getElementById('porcentaje-nuevo').value;
        ...
        if(dinero === ''){
            toastr.error('Dinero para aplicar es requerido');
            return;
        }
        ...
        axios.post('/admin/cupones/nuevo/descuentop ', formData, {
        })
        .then((response) => {
    ...
    function informacion(id){
        ...
        axios.post('/admin/cupones/info/descuentop',{
        'id': id 
            })
            .then((response) => {
                loadingOverlay().cancel(spinHandle);
                if(response.data.success == 1){
                    ...
                    // minimo de compra en carrito de compras para aplicar este descuento
                    $('#dinero-editar').val(response.data.info.dinero);
                    $('#porcentaje-editar').val(response.data.info.porcentaje);
                }else{
    ...
    // ajustes del cupon
    function editar(id){
        window.location.href="{{ url('/admin/cupones/vista/descp') }}/"+id;        
    }
    ...
    function editarInformacion(){
        ...
        var porcentaje = document.getElementById('porcentaje-editar').value;
        ...
        axios.post('/admin/cupones/editar/descuentop', formData, {
        })
        .then((response) => {
