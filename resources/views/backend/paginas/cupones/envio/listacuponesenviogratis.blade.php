...
<section class="content-header">
      <div class="container-fluid">
          <div class="col-sm-12">
            <h1>Lista de cupones para envio gratis</h1>
          </div>             
...
<!-- modal crear cupon envio gratis -->
<div class="modal fade" id="modalEnvioGratis">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Crear Cupón envío gratis</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formulario-gratis">
                    <div class="card-body">
                        <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Dinero minimo para aplicar este cupon</label>
                                    <input type="number" step="0.01" value="0" min="0" max="999" class="form-control" id="dinero-nuevo" placeholder="Limite uso cupon">
                                </div>
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-primary" onclick="nuevoCuponEnvioGratis()">Guardar</button>                
            </div>          
        </div>        
    </div>      
</div>
 ...
 <!-- incluir tabla --> 
  <script type="text/javascript">	 
    $(document).ready(function(){
        var ruta = "{{ URL::to('admin/cupones/tabla/lista') }}";
  ...
  <script>  
    ...
    function modal1(){
        document.getElementById("formulario-gratis").reset();
        $('#modalEnvioGratis').modal('show');
    } 

    // nuevo cupon para envio gratis
    function nuevoCuponEnvioGratis(){
        ...
        if(dinero === ''){
            toastr.error('Dinero minimo es requerido');
            return;
        }
        ...
        axios.post('/admin/cupones/nuevo/cupon/gratis ', formData, {
        })
        .then((response) => {
    ...
    // ajustes del cupon
    function editar(id){
        window.location.href="{{ url('/admin/cupones/vista/envio') }}/"+id;        
    }
    ...
    function editarInformacion(){
        ...
        axios.post('/admin/cupones/editar/informacion', formData, {
        })
        .then((response) => {
