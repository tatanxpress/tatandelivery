...
<section class="content-header">
      <div class="container-fluid">
          <div class="col-sm-12">
            <h1>Lista de cupones para Producto Gratis</h1>
          </div>             
                        ...
                        <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Dinero Minimo carrito</label>
                                    <input type="number" step="0.01" value="0" class="form-control" id="dinero-nuevo" placeholder="Dinero descuento">
                                </div>

                                <div class="form-group">
                                    <label>Nombre Producto a Regalar</label>
                                    <input type="text" maxlength="50" class="form-control" id="producto-nuevo" placeholder="Nombre del producto">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <select class="form-control" id="servicios-nuevo">   
                        ...
                        <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Dinero Minimo Carrito de Compras</label>
                                    <input type="number" step="0.01" min="0" max="200.00" value="0" class="form-control" id="dinero-editar" placeholder="Dinero descuento">
                                </div>

                                <div class="form-group">
                                    <label>Nombre producto</label>
                                    <input type="text" maxlength="50" class="form-control" id="producto-editar" placeholder="Nombre del producto">
                                </div>

                                <div class="form-group">
                                    <label>Nombre Servicio</label>
                                    <input type="text" disabled class="form-control" id="servicio-nombre">
                                </div>

                                <div class="form-group">
                                    <label>Identificador Servicio</label>
                                    <input type="text" disabled class="form-control" id="servicio-identificador">
                                </div>
 ...
 <!-- incluir tabla --> 
  <script type="text/javascript">	 
    $(document).ready(function(){
        var ruta = "{{ URL::to('admin/cupones/tabla/productos') }}";
  ...
  <script>  
    ...
    function nuevoCupon(){
        ...
        var idservicios = document.getElementById('servicios-nuevo').value;
        ...
        axios.post('/admin/cupones/nuevo/progratis ', formData, {
        })
        .then((response) => {
    ...
    function informacion(id){
        ...
        axios.post('/admin/cupones/info/progratis',{
        'id': id 
            })
            .then((response) => {
                loadingOverlay().cancel(spinHandle);
                if(response.data.success == 1){
                    ...
                    $('#dinero-editar').val(response.data.info.dinero_carrito);
                    $('#producto-editar').val(response.data.info.nombre);
                    $('#servicio-nombre').val(response.data.info.nombreservicio);
                    $('#servicio-identificador').val(response.data.info.identificador);
    ...
    function editarInformacion(){
        ...
        if(producto === ''){
            toastr.error('Nombre producto es requerido');
            return;
        }
        ...
        axios.post('/admin/cupones/editar/progratis', formData, {
        })
        .then((response) => {
