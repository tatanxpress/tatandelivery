...
<div class="modal fade" id="modalCredito">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Devolver Credito Utilizado</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Credito Utilizado (Verificado si uso cupón)</label>
                                    <input type="text" disabled class="form-control" id="credito-gastado">
                                </div>
...
@section('content-admin-js')
 ...
 <script>
  ...
  function modalCredito(id){
      document.getElementById("formulario-credito").reset();
      spinHandle = loadingOverlay().activate();

      axios.post('/admin/orden/credito-gastado-info',{
          'id': id
      })
          .then((response) => {
              loadingOverlay().cancel(spinHandle);
              ...
              if(response.data.success == 1){
                  ...
                  $('#credito-gastado').val(response.data.credito);
