...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <h1>Posición globlal de publicidad para todas las zonas</h1>
          </div>
...
<script src="{{ asset('js/frontend/loadingOverlay.js') }}" type="text/javascript"></script>
 ...
 <script type="text/javascript">
    $(document).ready(function(){
      var ruta = "{{ URL::to('admin/publicidad/tablas/tablasgloblal') }}";
...
function ordenarPosiciones(order){
    ...
    if(check){
        ...
        axios.post('/admin/publicidad/ordenar-globalmente',{ 
            'order': order,
            })
            .then((response) => {
