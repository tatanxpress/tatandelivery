@extends('backend.menus.superior')
 ...
 <section class="content-header">
       <div class="container-fluid">
           <div class="col-sm-12">
             <h1>Lista de pagos a servicios</h1>
           </div>  
...
<div class="modal fade" id="modalBuscar">
                        ...
                        <div class="row">  
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div>
                                        <select class="form-control selectpicker" id="servicio-identificador" data-live-search="true" required>   
                                            @foreach($servicio as $item)                                                
                                                <option value="{{$item->id}}">{{$item->identificador}}</option>
                                            @endforeach                                         
                                        </select>
 ...
 <script type="text/javascript">	 
    $(document).ready(function(){       
        var ruta = "{{ URL::to('admin/serviciopago/tabla/lista') }}";
   ...
   <script>
    ...
    function buscar(){
        var id = document.getElementById('servicio-identificador').value;  
        ...
        axios.post('/admin/registro/pago/ver',formData,{
            })
            .then((response) => {
    ...
    function respuesta(response){
        if (response.data.success == 0) {
            ...
            var ruta = "{{ url('/admin/serviciopago/tabla/lista') }}";
            $('#tablaDatatable').load(ruta);
