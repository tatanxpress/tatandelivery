...
Route::post('/admin', 'Auth\AdminLoginController@login')->name('admin.login.submit'); // inicio de sesion
  ...
  Route::post('/cliente/actualizar/extranjero/direccion','ClientesController@actualizarExtranjero');
      Route::post('/cliente/actualizar/extranjero/direccionv2','ClientesController@actualizarExtranjeroV2');

  // ver todas las direcciones extranjeros para editar rapidamente
  Route::get('/ver/toda/direccion-extranjero', 'ClientesController@indexTodaDireccionVerificadas');
  Route::get('/ver/toda/tabla/direccion-extranjero', 'ClientesController@tablaTodaDireccionVerificada');
