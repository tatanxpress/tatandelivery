...
Route::post('adminapp/cambiar/de/propietario', 'Api\AdminAppController@cambioDePropietario');
Route::post('adminapp/devolver/credito', 'Api\AdminAppController@devolverCreditoAdmin');
